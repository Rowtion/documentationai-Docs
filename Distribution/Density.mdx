...
![](https://raw.githubusercontent.com/Rowtion/documentationai-Docs/main/images/Density_demo.png)
...
![Mende, D. R. et al.(2016)](https://raw.githubusercontent.com/Rowtion/documentationai-Docs/main/images/Density_app1.jpg)
...
![Grimmer, M. R. et al.(2014)](https://raw.githubusercontent.com/Rowtion/documentationai-Docs/main/images/Density_app2.jpg)
...
![Reck, M. et al.(2015)](https://raw.githubusercontent.com/Rowtion/documentationai-Docs/main/images/Density_app3.jpg)
...
1.  Mende, D. R., Aylward, F. O., Eppley, J. M., Nielsen, T. N., & DeLong, E. F. (2016). Improved Environmental Genomes via Integration of Metagenomic and Single-Cell Assemblies. *Frontiers in Microbiology, 7*, 143. [https://doi.org/10.3389/fmicb.2016.00143](https://doi.org/10.3389/fmicb.2016.00143). PMID: 26904016; PMCID: PMC4749706.\
2.  Grimmer, M. R., Stolzenburg, S., Ford, E., Lister, R., Blancafort, P., & Farnham, P. J. (2014). Analysis of an artificial zinc finger epigenetic modulator: widespread binding but limited regulation. *Nucleic Acids Research, 42*(16), 10856--10868. [https://doi.org/10.1093/nar/gku708](https://doi.org/10.1093/nar/gku708). PMID: 25122745; PMCID: PMC4176344.
3.  Reck, M., Tomasch, J., & Wagner-Döbler, I. (2015). The Alternative Sigma Factor SigX Controls Bacteriocin Synthesis and Competence, the Two Quorum Sensing Regulated Traits in Streptococcus mutans. *PLoS Genetics, 11*(7), e1005353. [https://doi.org/10.1371/journal.pgen.1005353](https://doi.org/10.1371/journal.pgen.1005353). PMID: 26158727; PMCID: PMC4497675.\
4.  Wickham, H. (2016). *ggplot2: Elegant graphics for data analysis*. Springer. [https://ggplot2.tidyverse.org](https://ggplot2.tidyverse.org)\
5.  Gao, Y. (2021). *ggExtra: Add marginal plots to ggplot2*. [https://cran.r-project.org/package/ggExtra](https://cran.r-project.org/package/ggExtra)\
6.  Rudis, B. (2020). *hrbrthemes: Additional Themes and Theme Components for 'ggplot2'*. [https://cran.r-project.org/package/hrbrthemes](https://cran.r-project.org/package/hrbrthemes)\
7.  Wickham, H., François, R., Henry, L., & Müller, K. (2021). *dplyr: A Grammar of Data Manipulation*. [https://cran.r-project.org/package/dplyr](https://cran.r-project.org/package/dplyr)
8.  Wickham, H., & Henry, L. (2021). *tidyr: Tidy Messy Data*. [https://cran.r-project.org/package/tidyr](https://cran.r-project.org/package/tidyr)\
9.  Garnier, S. (2018). *viridis: Default Color Maps from 'matplotlib'*. [https://cran.r-project.org/package/viridis](https://cran.r-project.org/package/viridis)\
10. Aubry, R., & Bouchard, C. (2020). *ggpmisc: Miscellaneous Extensions to 'ggplot2'*. [https://cran.r-project.org/package/ggpmisc](https://cran.r-project.org/package/ggpmisc)\
11. Kassambara, A. (2021). *ggpubr: 'ggplot2' Based Publication Ready Plots*. [https://cran.r-project.org/package/ggpubr](https://cran.r-project.org/package/ggpubr)\
12. Brown, C. (2022). *geomtextpath: Curved Text on Geoms in 'ggplot2'*. [https://cran.r-project.org/package/geomtextpath](https://cran.r-project.org/package/geomtextpath)
13. Wilke, C. O. (2020). *cowplot: Streamlined Plot Theme and Plot Annotations for "ggplot2"*. [https://cran.r-project.org/package=cowplot](https://cran.r-project.org/package=cowplot)