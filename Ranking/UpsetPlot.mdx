...
![](https://raw.githubusercontent.com/Rowtion/documentationai-Docs/main/images/Ranking/UpsetPlot_demo1.png)

此图为 Upset 图的基本样式，图像分为三部分，分别是上方的不同集合之间交集的元素数量发直方图，左侧为不同集合包含元素数量的直方图。中间的矩阵部分则是集合之间的交集情况，如下图所示：

![](https://raw.githubusercontent.com/Rowtion/documentationai-Docs/main/images/Ranking/UpsetPlot_demo2.png)
...
![](https://raw.githubusercontent.com/Rowtion/documentationai-Docs/main/images/Ranking/UpsetPlot_app1.png)
