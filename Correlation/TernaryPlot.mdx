...
The data comes from the paper\[1]，The following is the link to the data code: [https://github.com/PlantNutrition/Liyu](https://github.com/PlantNutrition/Liyu)。
...
<Callout kind="tip" collapsed="false">
  **Four different themes in R language**
  ...
  - Black and white high contrast theme, white background with dark gray grid lines/borders. The grid lines are more prominent, suitable for black and white printing or emphasizing structured layouts. Clearer than the default theme theme\_grey, with no gradient gray background.
